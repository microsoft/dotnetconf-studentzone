...
|-------|---------|-----------|---|---|
| Welcome to the Student Zone!| Scott Hanselman, Katie Savage  |  |  | *Coming soon!* |
...
| Build a mobile app to track water consumption | Someleze Diko  | .NET MAUI | [using .NET MAUI to Build a Mobile App](/Using%20.NET%20MAUI%20to%20Build%20a%20Mobile%20App/Readme.md) | *Coming soon!* |
